  ...
  return (
    <View className="flex-1 bg-slate-100 items-center justify-center p-6">
      ...
      <View className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl p-6 mb-6 w-full">
        ...
        <Text className="text-5xl font-bold text-black text-center animate-pulse">
          {score}
        </Text>

        <Text className="text-black text-sm opacity-90 mt-2 text-center">
          {score >= 10
            ? "🏆 Excelente!"
            : score >= 5
              ? "👍 Bom trabalho!"
      ...
      <View className="w-full space-y-4">
        ...
        <TouchableOpacity
          onPress={() => router.push("/")}
          className="w-full bg-red-500 p-4 rounded-xl items-center shadow-lg mt-4
                       active:scale-95"
        >
          <Text className="text-white font-bold text-lg">
